import { version, unref, inject, useSSRContext, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, mergeModels, useModel, mergeProps, computed, isRef, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
...
const _routes = [
  {
    name: "ApplyNow",
    path: "/ApplyNow",
    component: () => import('./ApplyNow-O7ynF3PA.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BaaSBkLQ.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-gj1ZRwnH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BSfkZGMT.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, resolveUnrefHeadInput as d, entry$1 as default, __nuxt_component_0$1 as e, injectHead as i, nuxtLinkDefaults as n, resolveRouteObject as r, useRouter as u };
